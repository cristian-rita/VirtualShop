...
public class NewActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		lista.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			@Override
			public boolean onItemLongClick(AdapterView<?> adaptor, View arg1,
		...
		btn3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				alertDialog2
						.setMessage("Are you sure you want to buy these products worth: "
								+ total + "?");
						...
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
								...
								Toast.makeText(
										...
										"Your purchase is currently being processed. Thanks for using our App! :) ",
